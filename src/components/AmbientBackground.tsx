  ...
  return (
    <div ref={ref} className="fixed inset-0 pointer-events-none z-0 overflow-hidden"
      ...
      <motion.div
        ...
        style={{ opacity: "var(--orb-a-o)", width: "60vw", height: "60vw", maxWidth: "800px", maxHeight: "800px", y: y1, background: "radial-gradient(circle, var(--orb-a) 0%, transparent 70%)", filter: "blur(90px)", transform: "translateZ(0)", willChange: "transform" }}
      />
      ...
      <motion.div
        ...
        style={{ opacity: "var(--orb-b-o)", width: "70vw", height: "70vw", maxWidth: "900px", maxHeight: "900px", y: y2, background: "radial-gradient(circle, var(--orb-b) 0%, transparent 70%)", filter: "blur(100px)", transform: "translateZ(0)", willChange: "transform" }}
      />
