...
const EXPERIENCES = [
  { year: "2025", title: "Patent: Adjusting Perturbation Intensity", org: "시퀀셜 데이터의 시간적 변화량을 활용한 적대적 공격의 섭동 강도 조정 방법" },
  { year: "2024", title: "Patent: Audio Misclassification", org: "배음 구조를 활용한 오디오 오분류 유도 기법" },
  { year: "2024", title: "Grand Prize — AI Security Idea Contest", org: "KISA & KISIA" },
  { year: "2024", title: "Grand Prize — Cybersecurity Ideaathon", org: "Ministry of Science and ICT" },
  ...
  { year: "2020", title: "Mentor — SW Hackathon", org: "대학부설 과학영재 교육원 SW 해커톤 대회 멘토 활동" },
];
          ...
          <div className="flex-1 flex flex-col gap-0 border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
            {EXPERIENCES.map((ex, i) => (
              <motion.div key={ex.title + i}
                ...
                className="group flex flex-col sm:flex-row sm:items-center justify-between py-6 gap-4 sm:gap-10 border-b cursor-default transition-all duration-300"
              ...
              >
                ...
                <span className="shrink-0 text-xs font-medium px-2.5 py-1 rounded-full transition-colors duration-300 group-hover:bg-[#00C9A7] group-hover:text-[#0C0C0F]"
                  style={{
