  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          background: `radial-gradient(circle 600px at ${mousePos.x}px ${mousePos.y}px, rgba(var(--mint-rgb),0.07), transparent 70%)`,
        }}
      />
      ...
      <div className="section-inner w-full relative z-10 flex flex-col items-center flex-1 h-full">
        <div className="flex-1 flex flex-col justify-center items-center text-center max-w-5xl mx-auto w-full py-10">
          ...
          <motion.div
            ...
            style={{ borderColor: "rgba(var(--mint-rgb),0.3)", backgroundColor: "rgba(var(--mint-rgb),0.05)" }}
          >
            <p className="text-[0.65rem] md:text-xs tracking-[0.3em] uppercase font-bold"
              style={{ color: "var(--mint)", fontFamily: "'Inter', sans-serif", padding: "6px 20px" }}>
          ...
          <motion.a
            ...
            style={{
              backgroundColor: "rgba(var(--mint-rgb),0.1)",
              border: "1px solid rgba(var(--mint-rgb),0.4)",
              color: "var(--mint)",
              boxShadow: "0 10px 40px -10px rgba(var(--mint-rgb),0.4)"
            }}
          >
            {/* Hover Fill */}
